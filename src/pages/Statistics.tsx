  ...
  <div className="space-y-6">
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Performance de l'agence — Février 2026</p>
      </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <StatCard title="CA Total" value={formatMAD(7350000)} icon={DollarSign} variant="primary" trend={{ value: 18, positive: true }} />
      <StatCard title="Transactions" value={37} icon={FileText} variant="accent" trend={{ value: 12, positive: true }} />
      <StatCard title="Appels" value={300} icon={Phone} variant="default" />
      <StatCard title="Taux Transfo" value="24%" icon={TrendingUp} variant="warning" />
    </div>
