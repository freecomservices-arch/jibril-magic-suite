  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="CA Mensuel" value={formatMAD(totalCA)} icon={DollarSign} variant="primary" trend={{ value: 12, positive: true }} subtitle="Février 2026" />
        <StatCard title="Biens Actifs" value={availableProps} icon={Building2} variant="accent" trend={{ value: 8, positive: true }} subtitle={`${mockProperties.length} total`} />
        <StatCard title="Contacts" value={mockContacts.length} icon={Users} variant="default" trend={{ value: 15, positive: true }} subtitle="3 nouveaux cette semaine" />
        <StatCard title="Mandats Signés" value={mockTransactions.length} icon={FileSignature} variant="warning" trend={{ value: 5, positive: true }} subtitle="Ce mois" />
      </div>
